...
react_dom_1.render(react_1.default.createElement(react_tabber_1.default, { entries: entries },
...
var switchFuncPropTypes = {
    fnSwitchTo: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.func,
    fnSwitchPrevious: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.func,
    fnSwitchNext: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.func,
    fnSwitchFirst: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.func,
    fnSwitchLast: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.func
};
var entriesPropType = prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.arrayOf(prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.shape({
    label: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.node.isRequired,
    panel: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.node.isRequired,
    key: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.string, prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.number])
}));
var necessaryPropTypes = {
    entries: entriesPropType,
    mode: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.string,
    keyboardSwitch: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.bool,
    delayTriggerLatency: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.number,
    tabContainerClassName: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.string,
    labelContainerClassName: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.string,
    showHeaderLabelContainer: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.bool,
    showFooterLabelContainer: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.bool,
    labelItemClassName: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.string,
    panelContainerClassName: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.string,
    panelItemClassName: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.string
};
var callbackPropTypes = {
    onUpdateActivePosition: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.func,
    onUpdateTargetPosition: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.func,
    onSwitching: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.func,
    onSwitched: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.func
};
var eventPropTypes = {
    triggerEvents: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.string, prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.arrayOf(prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.string)]),
    delayTriggerEvents: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.string, prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.arrayOf(prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.string)]),
    delayTriggerCancelEvents: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.string, prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.arrayOf(prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.string)])
};
...
var publicPropTypes = __assign({}, necessaryPropTypes, callbackPropTypes, eventPropTypes, { activePosition: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.string, prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.number]) });
var tabPropTypes = __assign({}, necessaryPropTypes, callbackPropTypes, normalizedEventPropTypes, { activePosition: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.string, prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.number]) });
var tabContainerPropTypes = __assign({}, necessaryPropTypes, normalizedEventPropTypes, switchFuncPropTypes, { tabContext: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.object, currentIndex: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.number });
var labelContainerPropTypes = __assign({}, normalizedEventPropTypes, switchFuncPropTypes, { entries: entriesPropType, mode: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.string, keyboardSwitch: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.bool, delayTriggerLatency: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.number, labelContainerClassName: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.string, labelItemClassName: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.string, tabContext: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.object, currentIndex: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.number, side: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.string });
var panelContainerPropTypes = {
    entries: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.arrayOf(prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.object),
    mode: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.string,
    panelContainerClassName: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.string,
    panelItemClassName: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.string,
    tabContext: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.object,
    currentIndex: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.number,
    refLabelSide: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.string
};
...
var LabelContainer = /** @class */ (function (_super) {
    ...
    LabelContainer.prototype.render = function () {
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: labelContainerAllClassName, role: "tablist" }, entries.map(function (entry, index) {
...
var PanelContainer = /** @class */ (function (_super) {
    ...
    PanelContainer.prototype.render = function () {
        ...
        var tabberId = tabContext.tabberId;
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: panelContainerAllClassName }, entries.map(function (entry, index) {
            ...
            return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", __assign$3({}, panelProps, { className: panelItemAllClassName, id: getPanelItemId(tabberId, index), role: "tabpanel", "aria-labelledby": getLabelItemId(tabberId, refLabelSide, index), "aria-hidden": !isActive, key: key ? 'key-' + key : 'index-' + index }), entry.panel);
        }));
    };
...
function TabContainer(props) {
    ...
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: tabContainerClassName + ' ' + tabContainerModeClassName },
        showHeaderLabelContainer ?
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(LabelContainer, { entries: entries, mode: mode, keyboardSwitch: keyboardSwitch, delayTriggerLatency: delayTriggerLatency, labelContainerClassName: labelContainerClassName, labelItemClassName: labelItemClassName, tabContext: tabContext, currentIndex: currentIndex, side: ClassNameSuffix.header, triggerEvents: triggerEvents, delayTriggerEvents: delayTriggerEvents, delayTriggerCancelEvents: delayTriggerCancelEvents, fnSwitchTo: fnSwitchTo, fnSwitchPrevious: fnSwitchPrevious, fnSwitchNext: fnSwitchNext, fnSwitchFirst: fnSwitchFirst, fnSwitchLast: fnSwitchLast }) : null,
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(PanelContainer, { mode: mode, panelContainerClassName: panelContainerClassName, panelItemClassName: panelItemClassName, tabContext: tabContext, currentIndex: currentIndex, entries: entries, refLabelSide: showHeaderLabelContainer || !showFooterLabelContainer ? ClassNameSuffix.header : ClassNameSuffix.footer }),
...
var ReactTabber = /** @class */ (function (_super) {
    ...
    ReactTabber.prototype.render = function () {
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Tab, __assign$4({}, props, { entries: parseTabEntries(entries, children), triggerEvents: normalizeEvents(triggerEvents), delayTriggerEvents: normalizeEvents(delayTriggerEvents), delayTriggerCancelEvents: normalizeEvents(delayTriggerCancelEvents) }));
    };
